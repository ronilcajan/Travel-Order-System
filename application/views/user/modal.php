                    ...
                    <div class="text-center">
                        ...
                        <div class="row text-center m-b-20 m-t-10">
                            <button class="btn btn-danger waves-effect btn-rounded waves-light" type="button"
                                id="open_cam2" data-toggle="tooltip" data-original-title="Open Camera"> <i
                                    class="fa fa-camera"></i> </button>
                            <button type="button" class="btn btn-primary waves-effect btn-rounded waves-light"
                                onclick="save_photo2()" data-toggle="tooltip" data-original-title="Capture"><i
                            ...
                            <div class="form-group">
                                <div class="form-group form-floating-label">
                                    ...
                                    <select class="form-control" name="group" required>
                                        ...
                                        <?php if($this->ion_auth->in_group(1) && $row->name == 'super-admin') : ?>
