                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($sess->id != $row->id) : ?>
                                    <a href="<?= site_url('auth/delete_user/') . $row->id ?>" onclick="return confirm('Are you sure you want to delete this user?');" data-toggle="tooltip" data-original-title="Remove">
