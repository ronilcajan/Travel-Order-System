...
class Resident extends CI_Controller
{
    ...
    public function getresidentscerts()
    {
        ...
        foreach ($list as $res) {
            ...
            $row[] = $res->pwd;
            $row[] = '<a type="button" href="' . site_url('admin/generate_brgy_cert/') . $res->id . '" data-toggle="tooltip" title="Generate Barangay Certificate"><i class="fa fa-file-text-o text-inverse m-r-10"></i> </a>
                    <a type="button" href="' . site_url('admin/generate_indi_cert/') . $res->id . '" data-toggle="tooltip" title="Generate Indigency Certificate"><i class="fa fa-file-text-o text-info m-r-10"></i> </a>
                    <a type="button" href="' . site_url('admin/generate_resi_cert/') . $res->id . '" data-toggle="tooltip" title="Generate Residency Certificate"><i class="fa fa-file-text-o text-success m-r-10"></i> </a>';
